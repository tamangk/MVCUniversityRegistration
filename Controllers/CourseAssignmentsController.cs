...
namespace MVCUniversityRegistration.Controllers
{
    public class CourseAssignmentsController : Controller
    {
        ...
        public CourseAssignmentsController(MVCUniversityRegistrationContext context)
        {
            _context = context;
        }
        ...
        {
            var mVCUniversityRegistrationContext = _context.CourseAssignment.Include(c => c.Course).Include(c => c.Instructor);
