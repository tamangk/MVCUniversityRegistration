...
namespace MVCUniversityRegistration.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(MVCUniversityRegistrationContext context)
        {
            _context = context;
        }
        ...
        {
            var mVCUniversityRegistrationContext = _context.Enrollment.Include(e => e.Course).Include(e => e.Student);
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentID,CourseID,StudentID,Grade")] Enrollment enrollment)
        {
            ...
            ViewData["StudentID"] = new SelectList(_context.Student, "ID", "FirstMidName", enrollment.StudentID);
            return View(enrollment);
        }
