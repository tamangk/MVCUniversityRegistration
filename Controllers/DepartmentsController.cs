...
namespace MVCUniversityRegistration.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(MVCUniversityRegistrationContext context)
        {
            _context = context;
        }
        ...
        {
            var mVCUniversityRegistrationContext = _context.Department.Include(d => d.Administrator);
